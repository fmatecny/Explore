...
public class Water implements Disposable {
	...
	private Set<AbstractMap.SimpleEntry<Fixture, Fixture>> fixturePairs; // contacts between this object and other dynamic bodies
	...
	public void update() {
		if (body != null && fixturePairs != null) {
			...
			for (AbstractMap.SimpleEntry<Fixture, Fixture> pair : fixturePairs) {
	...
	public Set<AbstractMap.SimpleEntry<Fixture, Fixture>> getFixturePairs() {
		return fixturePairs;
	}

	public void setFixturePairs(Set<AbstractMap.SimpleEntry<Fixture, Fixture>> fixturePairs) {
