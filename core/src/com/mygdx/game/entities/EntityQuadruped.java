 ...
 * @author Fery
 */
public abstract class EntityQuadruped extends Entity{
    
    public EntityQuadruped(Builder b){
        super(b);
        if (heightInBlocks == 0)
            heightInBlocks = 1.4f;
        if (entityTextureSizeRatio == 0)
            entityTextureSizeRatio = 166f/216f;
        setSize();
    ...
    protected void defineBody(float x, float y){
        ...
        square.setPosition(new Vector2(-Block.size_in_meters*0.45f, 0));
        ...
        right.set(new Vector2(0.15f+Block.size_in_meters*0.45f, -0.1f), new Vector2(0.23f+Block.size_in_meters*0.45f, -0.1f));
        ...
        left.set(new Vector2(-0.15f-Block.size_in_meters*0.45f, -0.1f), new Vector2(-0.23f-Block.size_in_meters*0.45f, -0.1f));
